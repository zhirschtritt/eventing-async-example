...
Starting from Go 1.23, the language added _range-over-function_ feature, allowing users to define custom iterators
...
It gives more control and performs all necessary cleanup and draining, even if the loop is terminated early using _break_ or _return_.
